...
export const Mutations = {
  ...
  // ************ Newsletter ***********
  useCreateNewsletter: (options?: AppMutationOptions<CreateNewsletterResponse, CreateNewsletterPayload>) => useMutations<CreateNewsletterPayload, CreateNewsletterResponse>([KEYS.NEWSLETTER.ADD_NEWSLETTER], (input) => Post<CreateNewsletterPayload, CreateNewsletterResponse>(URL_KEYS.NEWSLETTER.ADD, input), options),

  // ************ Payment ***********
  useCreateRazorpayPayment: (token?: string, options?: AppMutationOptions<RazorpayCreatePaymentResponse, RazorpayCreatePaymentPayload>) => useMutations<RazorpayCreatePaymentPayload, RazorpayCreatePaymentResponse>([KEYS.PAYMENT.RAZORPAY_CREATE], (input) => Post<RazorpayCreatePaymentPayload, RazorpayCreatePaymentResponse>(URL_KEYS.PAYMENT.RAZORPAY_CREATE, input, token), options),
  useVerifyRazorpayPayment: (token?: string, options?: AppMutationOptions<RazorpayVerifyPaymentResponse, RazorpayVerifyPaymentPayload>) =>  useMutations<RazorpayVerifyPaymentPayload, RazorpayVerifyPaymentResponse>([KEYS.PAYMENT.RAZORPAY_VERIFY], (input) => Post<RazorpayVerifyPaymentPayload, RazorpayVerifyPaymentResponse>(URL_KEYS.PAYMENT.RAZORPAY_VERIFY, input, token), options),
  useCreatePhonepePayment: (token?: string, options?: AppMutationOptions<PhonepeCreatePaymentResponse, PhonepeCreatePaymentPayload>) => useMutations<PhonepeCreatePaymentPayload, PhonepeCreatePaymentResponse>([KEYS.PAYMENT.PHONEPE_CREATE], (input) => Post<PhonepeCreatePaymentPayload, PhonepeCreatePaymentResponse>(URL_KEYS.PAYMENT.PHONEPE_CREATE, input, token), options),
};
